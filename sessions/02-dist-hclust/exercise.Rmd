...
1.  `players` = these are players and their *aggregate* performance over the course of a season.  For more on what the column names, refer to the source of the data here^[ https://www.hockey-reference.com/leagues/NHL_2019_skaters.html]

1.  `teams` = *aggregate* performance of teams for the 2018-19 season.  Information about the columns can be found here^[https://www.hockey-reference.com/leagues/NHL_2019.html]
